...
if(isset($_POST['mobno'])){
     $sql="INSERT INTO `exam_copy_recheck`(`exam_roll_no`,`papercode`,`course` ,`mobile_no`,`remark`) VALUES ('".$_POST['rollno']."','".$_POST['papercode']."','".$_POST['course']."','".$_POST['mobno']."','".$_POST['remark']."')";
  ...
  <div class="row">
    ...
    <div  style="">
        <div class="container-fluid">
            ...
            <div id="result" style="font-size:1.5rem;text-align:center;color:red;">Total Payable Amount is 2500 &#8377; Only. </div>
            <div class="col-12 text-center">

                <a href="challenge_evaluation_reg.php" class="btn btn-primary printButton">Back & Edit</a>
	            ...
	            <form action="reeval_ccavRequestHandler.php" method="POST">
                    ...
                    <span style="">
                        ...
                        Redirect URL	:<input type="text" name="redirect_url" value="https://knipssexams.in/recheck_ccavResponseHandler.php"/>
                        Cancel URL	:<input type="text" name="cancel_url" value="https://knipssexams.in/recheck_ccavResponseHandler.php"/>
                        Language	:<input type="text" name="language" value="EN"/>
                        Billing Name	:<input type="text" name="billing_name" value="<?php echo $row['student_name']?>"/>
                        Billing Address	:<input type="text" name="billing_address" value="<?php echo $row['p_address']?>"/>
                        Billing City	:<input type="text" name="billing_city" value="<?php echo $row['p_district']?>"/>
                        Billing State	:<input type="text" name="billing_state" value="<?php echo $row['p_state']?>"/>
                        Billing Zip	:<input type="text" name="billing_zip" value="<?php echo $row['p_pin']?>"/>
                        Billing Country	:<input type="text" name="billing_country" value="India"/>
                        Billing Tel	:<input type="text" name="billing_tel" value="<?php echo $row['mobile']?>"/>
                        Billing Email	:<input type="text" name="billing_email" value="<?php echo $row['e_mail1']; ?>"/>
                        Merchant Param1	:<input type="text" name="merchant_param1" value="<?php echo $_POST['exam_roll_no'];?>"/>
                        Merchant Param2	:<input type="text" name="merchant_param2" value="<?php echo $_POST['result_course'];?>"/>
                        Merchant Param3	:<input type="text" name="merchant_param3" value="<?php echo $_POST['mobile_no'];?>"/>
                        Merchant Param4	:<input type="text" id="pcode" name="merchant_param4" value="<?php echo $newappno; ?>"/>
                        Student ID	:<input type="text" name="student_id" value="<?php echo $row['snoo']; ?>"/>
