...
$sql1="SELECT * FROM `exam_copy_view` WHERE sno = '".$_POST['examcopyviewsno']."'";
$res1=mysqli_query($db,$sql1);
$row1=mysqli_fetch_assoc($res1);
// echo mysqli_num_rows($res1);

$bank_reference_no=$row1['bank_trans_no'];
$appno=$row1['sno'];
$_POST['exam_roll_no']=$row1['exam_roll_no'];
$_POST['result_course']=$row1['course'];
$_POST['mobile_no']=$row1['mobile_no'];
$_POST['papercode']=$row1['papercode'];
