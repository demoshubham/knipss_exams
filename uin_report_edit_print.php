...
if(isset($_GET['finalsubmit'])){
  //$uin='KNI'.date('Y').str_pad($_GET['finalsubmit'], 4, '0', STR_PAD_LEFT);
...
//$result = mysqli_query($db, $query);
	...
	if(isset($_GET['edit'])){
	$sql= 'select * from admission_student_info where sno = '.$_GET['sno'];
          ...
          <table class="table table-bordered table-light">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td colspan="2"><?php echo $details['candidate_name'] ?></td>
                <th>GENDER:</th>
        ...
        <table class="table table-bordered">
          <tr>
            <td>
			 ...
			 <?php
					echo '<a href="uin_report_edit.php?edit='.$details['sno'].'&id='.$details['sno'].'" class="btn btn-success"> Go back to Edit</a>';
				?>
				<!-----
				<a href="uin_report_edit.php?edit=<?php //echo $details['sno'].'&id='.$details['sno']?>" class="btn btn-success"> Go back to Edit</a>
