...
if(isset($_POST['save_form'])){
	...
	if($_POST['student_name']==''){
		$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Student name.</li>';
	}
	if($_POST['father_name']==''){
		$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Father Name.</li>';
	}
	if($_POST['mother_name']==''){
		$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Mother Name.</li>';
	}
	if($_POST['dob']==''){
		$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Date of Birth.</li>';
	}
	if($_POST['p_address']==''){
		$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Correspondence Address.</li>';
	}
	if($_POST['p_district']==''){
		$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Correspondence Disrict.</li>';
	}
	if($_POST['p_post']==''){
		$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Correspondence Post.</li>';
	}
	if($_POST['p_state']==''){
		$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Correspondence State.</li>';
	}
	if($_POST['p_pin']==''){
		$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Correspondence Pin.</li>';
	}
	if($_POST['mobileno']==''){
		$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Mobile Number.</li>';
	}
	if($_POST['caste']==''){
		$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Caste.</li>';
	}
	if($_POST['dob']==''){
	...
	if($class_details['category']=='PG'){
		if($_POST['grad_year']==''){
			$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Graduation Year Details.</li>';
		}
		if($_POST['grad_board']==''){
			$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Graduation Board Details.</li>';
		}
		if($_POST['grad_roll_no']==''){
			$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Graduation Roll No. Details.</li>';
		}
		if($_POST['grad_college']==''){
			$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Graduation College Details.</li>';
		}
		if($_POST['grad_obt']==''){
			$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Graduation Marks Obtained Details.</li>';
		}
		if($_POST['grad_total']==''){
			$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Graduation Total Marks Details.</li>';
		}
		if($_POST['grad_exam_name']==''){
			$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Graduation Details.</li>';
		}
		if($_POST['sub1']==''){
			$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please Select Subject.</li>';
		}
	}
	if($class_details['category']=='UG'){
		if($_POST['inter_year']==''){
			$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Intermediate Year Details.</li>';
		}
		if($_POST['inter_board']==''){
			$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Intermediate Board Details.</li>';
		}
		if($_POST['inter_roll_no']==''){
			$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Intermediate Roll No. Details.</li>';
		}
		if($_POST['inter_college']==''){
			$msg .= '<li class="error" style="font-size:24px;" style="font-size:24px;">Please enter Intermediate College Details.</li>';
		}
		if($_POST['inter_obt']==''){
			$msg .= '<li class="error" style="font-size:24px;">Please enter Intermediate Marks Obtained Details.</li>';
		}
		if($_POST['inter_total']==''){
			$msg .= '<li class="error" style="font-size:24px;">Please enter Intermediate Total Marks Details.</li>';
		}
		if($_POST['sub1']=='' || $_POST['sub2']=='' || $_POST['sub3']==''){
			$msg .= '<li class="error" style="font-size:24px;">Please Select Subjects.</li>';
		}
	}
	$sql='select * from student_info where sno="'.$_POST['student_id'].'"';
	$details=mysqli_fetch_array(execute_query($sql,dbconnect()));
	if($details['photo_id']==''){
		$msg .= '<li class="error" style="font-size:24px;">Please Upload Your Photo.</li>';
	}
	if($details['signature_id']==''){
		$msg .= '<li class="error" style="font-size:24px;">Please Upload Your Signature.</li>';
	}
	if(!isset($_POST['ncc'])){
		$_POST['ncc'] = '';
	}
	...
	$response=1;
	if($msg==''){
		$msg .= '<li class="error" style="font-size:24px;">Data saved succesfully.</li>';
		$verify = 1;
	}
	else{
		$verify = 0;
...
if(isset($_POST['submit'])){
	...
	if($_POST['verify_data']==0){
		$msg .= '<li class="error" style="font-size:24px;">You Have One or more errors on this page.</li>';
		$response=1;
	}
}
...
if(isset($_POST['submit2'])){
	if($_POST['declaration']=='Yes'){
		...
		$msg .= '<li class="error" style="font-size:24px;">Please Select the Declaration.</li>';
		$response=2;
		}
}
page_header();
...
<div style="width:100%; background:#027cd1; height:28px; text-align: right; color: #ffffff; font-size: 20px; font-weight: bold;">
	...
	<div style="margin-right: 50px; float:right;">Registration Number-<?php echo $register_user['user_name'];?>&nbsp; | &nbsp; <a href="logout.php" style="color:#fff;">Logout </a>&nbsp;</div>
</div>
		...
		<table width="100%" style="border:1px solid;">
			...
			<tr>
				...
				<td>
					...
					<option value=""></option>
					<?php
					$sql = 'select * from class_detail where category="PG" order by class_description';
...
<div id="container" class="ltr" style="width:100%; float:none;">
    ...
    <h2>Your Registration Number is-<?php echo $register_user['user_name'];?></h2>
    <form>
       <?php echo $msg;
	   	// print_r ($_POST); ?>
	   	<?php
		if($stu_id['status']==1){
			echo '<li class="error" style="font-size:24px;"><h2>Admission for submitted successfully. Please print application form from the bottom of the page.</h2></li>';
		}
		else{
			echo '<li class="error" style="font-size:24px;"><h2>Please verify your data carefully. You will not be able to modify it later.</h2></li>';
		}
		?>
	</form>
		<table width="100%">
		...
		<table>
          ...
          <tr>
          		<td class="label highlight" style="font-size:24px;">
                <b>DECLARATION-
				...
				?>
                <input type="checkbox"  id="weightage"  name="declaration" value="Yes" <?php if($stu_id['declaration']=="Yes"){ echo 'checked';}?> style="vertical-align:bottom; height:20px; width:20px;"/> 
                <?php } ?>
                </td>
		  </table>
            <?php 
...
<div id="container" class="ltr" style="width:100%; float:none;">
		<h2> Fees Payment </h2>
        <form action="meTrnPay.php" class="leftLabel page1 pure-form" name="admission_newadmission" enctype="multipart/form-data" method="post" onSubmit="" >
		<?php echo $msg;?>
		<table width="100%" style="border:1px solid;">	
		<tr>
				<td class="label">Student Name</td>
			...
			<tr>
				...
				<input type="hidden" value="<?php echo $stu_id['sno'].time();?>" id="OrderId" name="OrderId">
			...
			<tr>
				<td colspan="4" align="center"><input type="submit" class="btTxt submit" name="submit_fees" value="Proceed for Payment" onClick="return confirmSubmit()"/></td>
			</tr>
		</table>	
